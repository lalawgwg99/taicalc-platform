          ...
          <div className="space-y-6">
            ...
            {showSettings && (
              <div className="p-4 bg-gray-50 rounded-md border">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="quality-range">
                      圖片品質: {quality}%
                    </label>
                    <input
                      id="quality-range"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="image-select">
                      選擇示例圖片
                    </label>
                    <select
                      id="image-select"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div>
                ...
                <div className="border rounded-lg overflow-hidden relative h-64 w-full">
                  <Image
