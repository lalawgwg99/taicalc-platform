...
import { ChevronLeft, Zap, TrendingUp } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-brand-background font-sans pb-32 flex flex-col items-center justify-center text-center px-6 relative overflow-hidden">
            ...
            <div className="glass-card p-12 rounded-[40px] max-w-2xl w-full border border-white/50 shadow-2xl relative z-10">
                <div className="w-20 h-20 bg-brand-warning/10 rounded-3xl flex items-center justify-center mx-auto mb-8 text-brand-warning shadow-inner">
                    <TrendingUp className="w-10 h-10" />
                </div>
                <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight">
                    資本決策 <span className="text-brand-warning">Coming Soon</span>
                </h1>
                <p className="text-lg text-slate-500 font-medium leading-relaxed mb-10">
                    長期資產增長藍圖正在運算中。<br />整合複利效應、通膨預測與現金流模擬的戰略工具。
                </p>
